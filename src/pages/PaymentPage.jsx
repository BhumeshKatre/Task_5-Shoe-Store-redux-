            ...
            <div className="px-4 py-3  md:w-[70vw] md:mx-auto box-border ">
              ...
              <div className="flex md:flex-row flex-col md:justify-between md:px-4 py-3 gap-4 ">
                ...
                <div className="p-4 bg-white w-92 rounded-lg  md:order-2 order-1 h-full ">
                  ...
                  <div className="py-4 ">
                    {
                      cartItems.map((items, indx) => (
                        <div
                        key={indx}
                          className="flex justify-between border-b border-sky-100 py-4">
                          <div>
                            <h2 className="text-sm font-semibold ">{items.name}</h2>
                            <div className="text-xs space-x-4">
                              <span>{items.brand} </span> <span> size:{items.size} </span> <span>Qty.{items?.quantity ? 'items?.quantity' : 1}</span>
                            </div>
                          </div>
                      ...
                      <div className=" ">
                        ...
                        <div className="p-2 border-t border-gray-300 flex justify-between">
                          ...
                          <p className=" text-sky-400 font-bold text-xl">
                            {Math.floor(itemTotalPrice > 100 ? itemTotalPrice : itemTotalPrice + 100)}
                          </p>
                        </div>
